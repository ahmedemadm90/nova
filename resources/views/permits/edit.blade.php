...
<div class="container text-capitalize text-center" style="font-family: sans-serif">
    ...
    <div class="row">
        <form class="row m-auto text-center" action="{{route('workers.update',$worker->id)}}" method="POST"
            ...
            <div class="row m-auto p-1">
                ...
                <div class="col-md-3 m-auto">
                    <div class="form-floating">
                        <input type="text" class="form-control" name="job" placeholder="job" value="{{$worker->job}}">
                ...
                <div class="col-md-3 m-auto">
                    <div class="form-floating">
                        <select name="title_id" id="title_id" class="form-select text-capitalize">
                            ...
                            <option value="{{$title->id}}" @if ($worker->title_id == $title->id)
                                selected
                ...
                <div class="col-md-3 m-auto">
                    <div class="form-floating">
                        <input class="form-control text-capitalize" name="company" id="company"
                            placeholder="worker company" value="{{$worker->company}}">
                    ...
                    <div class="form-floating">
                        <select name="emp_man" class="form-select text-capitalize">
                            ...
                            <option value="{{$admin->id}}" @if ($worker->worker_manager_id == $admin->id)
                                selected
                                @endif>{{$admin->name}} || {{$admin->title->title_name}}</option>
                            @endforeach
                        </select>
