@extends('layouts.app')
@section('title')
{{__('UAE Vilations')}} || {{__('From ')}} {{$date_from}} {{__('To ')}}{{$date_to}}
@endsection
@section('header')
...
@section('content')
<div class="row">
    <a class="btn btn-primary col-md-1" href="{{route('uae.violations.index')}}">{{__('Back')}}</a>
    <form action="{{route('uae.violations.exportdate')}}" class="col-md-3">
